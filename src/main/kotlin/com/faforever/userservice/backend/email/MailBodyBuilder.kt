...
class MailBodyBuilder(private val properties: FafProperties) {
    ...
    enum class Template(vararg variables: String) {
        ...
        PASSWORD_CHANGE_CONFIRMATION("username", "confirmationUrl"),
    ...
    private fun getTemplateFilePath(template: Template): Path {
        val path = when (template) {
            ...
            Template.PASSWORD_CHANGE_CONFIRMATION -> properties.account().passwordChange().mailTemplatePath()
    ...
    fun buildEmailChangeConfirmationBody(username: String, confirmationUrl: String) =
        populate(
    ...
    fun buildEmailChangedNotificationBody(username: String, newEmail: String) =
        populate(
    ...
    fun buildPasswordChangeConfirmationBody(username: String, confirmationUrl: String) =
        populate(
