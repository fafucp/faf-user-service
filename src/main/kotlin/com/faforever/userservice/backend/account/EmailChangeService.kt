...
sealed interface EmailChangeConfirmationResult {
    ...
    data object PendingChangeExpired : EmailChangeConfirmationResult
...
class EmailChangeService(
    ...
    fun confirmEmailChange(token: String): EmailChangeConfirmationResult {
        ...
        if (pendingChange.expiresAt.isBefore(OffsetDateTime.now())) {
            accountRequestRepository.delete(pendingChange)
            return EmailChangeConfirmationResult.PendingChangeExpired
        }
